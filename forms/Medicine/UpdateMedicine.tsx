import { AddMedicinePayload } from '@/api/interfaces';
...
export default function UpdateMedicineForm({ data, onSubmit }: UpdateMedicineFormProps) {
	const formMethods = useForm<MedicineSchema>({
		...
		defaultValues: {
			...
			isContinuos: data.datePeriod.start === data.datePeriod.end,
			newScheduleInput: '',
		},
	});
